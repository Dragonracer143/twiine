...
const Ratingmanage = () => {
    ...
    const avarageRatingCount = () => {
        ...
        let avarageRating = ((1 * oneStar) + (2 * twoStar) + (3 * threeStar) + (4 * fourStar) + (5 * fiveStar)) / startData.length;
    ...
    return (<>
        ...
        <div className="listing-table list-wrappers">
            <div className="table-card">
                ...
                <p>Average rating - {avarageRatingCount()}<i class="fa fa-star rate" aria-hidden="true"></i></p>
            </div>
        </div>
    </>
    )
