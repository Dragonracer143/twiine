...
const ListingForm = () => {
  return (
    ...
    <div class="mb-3 mt-3">
      ...
      <input type="text" className='form-control' id="text" placeholder="Business" name="text"/>
    </div>
    <div className='mb-3'>
      <label for="text">Street Address</label>
      <input type="password" className='form-control' id="text" placeholder="Address" name="text"/>
    </div>
    <div className='mb-3'>
    ...
    <div className='mb-3'>
      ...
      <input type="text" className='form-control' id="text" placeholder="URL" name="text"/>
    </div>
    <div className='mb-3'>
