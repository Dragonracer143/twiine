      ...
      <div className="result">
        <div className="inner">
          <div className="content">
            <h1>
              <img src="./img/twiine2.png" alt="" /> Recommends...
            </h1>
          </div>
            ...
            <>
                ...
                return (
                  <>
                    <div key={index} className="cartt">
                      <p className="fire_content">
                        {index === 0 && " Highly Recommended"}
                      </p>
              ...
              {filteredData.length > 3 ? (
                <div className="get-three-more">
                  <button
                    className="Visit_btn more_result_btn fw-bold"
                    onClick={() => {
                      setI((old) => {
                        let nexti = old + 3;
                  ...
                  >
                    <span className="text-dark fw-bold">Not satisfied?</span>
                    <br />
                    Get <span className="fst-italic  text-dark">3</span> more
                    recommendation here!
                  </button>{" "}
                </div>
              ) : (
              ...
              <div className="How-are-these-results">
                <button
                  type="submit"
                  className="rating-submit fw-bold"
                  onClick={(e) => {
                    AddRatinghandler(e);
                  }}
                >
                ...
                {loaderState ? (
                  ...
                  <>
                    ...
                    {tempFilteredData.length > 0 && (
                      <>
                        <button
                          className="Visit_btn viewAgainbtn"
                          onClick={() => {
        ...
        <button onClick={handleClick} className="exit_btn" type="button">
          Exit
        </button>
      </div>
    </>
